...
\begin{itemize}
\item
Glaudin/PLC - async implementation could be pretty efficient
\item
Eckstein/PLC - no async implementation has ever been done, although
it is the first-in-class for fully nonsmooth problems.
\item
Application areas:

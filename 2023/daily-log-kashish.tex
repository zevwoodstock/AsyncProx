...
\begin{itemize}
    ...
    \item Read the research paper on Asynchronous and Block-Iterative Operator Splitting and found the follwowing resources helpful while studying the paper:
    \begin{itemize}
